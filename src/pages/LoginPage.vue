  ...
  setup() {
    ...
    const submit = async () => {
      ...
      try {
        ...
        const fromRegisterToLogin = sessionStorage.getItem('fromRegisterToLogin');
        if (fromRegisterToLogin) {
          router.push('/');
          sessionStorage.removeItem('fromRegisterToLogin');
        } else {
          router.go(-1);
        }
      } catch (error) {
          ...
          <div class="card border border-light-subtle rounded-3 shadow-sm">
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="text-center mb-3">
                <a href="#!">
                  <img src="https://cdn.iconscout.com/icon/free/png-256/free-recommendation-438971.png?f=webp"
                       alt="Logo" width="175" height="120">
                </a>
              </div>
